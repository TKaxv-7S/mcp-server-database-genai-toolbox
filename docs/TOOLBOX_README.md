...
3.  Create your [`tools.yaml` configuration file](https://googleapis.github.io/mcp-toolbox/getting-started/configure/).
...
For more information, visit the [MCP Toolbox for Databases documentation](https://googleapis.github.io/mcp-toolbox/getting-started/introduction/).
