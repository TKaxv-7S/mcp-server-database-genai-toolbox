...
| parameters         |   [parameters](../source.md#specifying-parameters)    |    false     | List of [parameters](../source.md#specifying-parameters) that will be inserted into the SQL statement.                                          |
| templateParameters | [templateParameters](../source.md#template-parameters) |    false     | List of [templateParameters](../source.md#template-parameters) that will be inserted into the SQL statement before executing prepared statement. |
