...
Configure your OpenTelemetry `TracerProvider` and `MeterProvider` before creating the client. See the [toolbox-core OpenTelemetry documentation](https://googleapis.github.io/mcp-toolbox/sdks/python-sdk/core/#opentelemetry) for a full setup example.
