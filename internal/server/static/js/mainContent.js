...
function getHomepageInstructions() {
    return `
      <div class="resource-instructions">
        ...
        <a href="https://googleapis.github.io/mcp-toolbox/how-to/use-toolbox-ui/" class="btn btn--externalDocs" target="_blank" rel="noopener noreferrer">Toolbox UI Documentation</a>
      </div>
    `;
}
...
function getToolInstructions() {
    return `
      <div class="resource-instructions">
        ...
        <a href="https://googleapis.github.io/mcp-toolbox/resources/tools/" class="btn btn--externalDocs" target="_blank" rel="noopener noreferrer">Tools Documentation</a>
      </div>
    `;
}
...
function getToolsetInstructions() {
    return `
      <div class="resource-instructions">
        ...
        <a href="https://googleapis.github.io/mcp-toolbox/getting-started/configure/#toolsets" class="btn btn--externalDocs" target="_blank" rel="noopener noreferrer">Toolsets Documentation</a>
      </div>
    `;
}