...
[![Docs](https://img.shields.io/badge/Docs-MCP_Toolbox-blue)](https://googleapis.github.io/mcp-toolbox/)
...
This README provides a brief overview. For comprehensive details, see the [full documentation](https://googleapis.github.io/mcp-toolbox/).
...
2. Set the appropriate environment variables to connect, see the [Prebuilt Tools Reference](https://googleapis.github.io/mcp-toolbox/reference/prebuilt-tools/).
...
For a full list of available tools and their capabilities across all supported databases, see the [Prebuilt Tools Reference](https://googleapis.github.io/mcp-toolbox/reference/prebuilt-tools/).
...
[Prompts](https://googleapis.github.io/mcp-toolbox/resources/prompts).
...
> curl -L -o toolbox https://storage.googleapis.com/mcp-toolbox/v$VERSION/linux/amd64/toolbox
> chmod +x toolbox
> ```
>
> </details>
...
> # see releases page for other versions
> export VERSION=0.31.0
> curl -L -o toolbox https://storage.googleapis.com/mcp-toolbox/v$VERSION/darwin/arm64/toolbox
> chmod +x toolbox
> ```
>
> </details>
...
> # see releases page for other versions
> export VERSION=0.31.0
> curl -L -o toolbox https://storage.googleapis.com/mcp-toolbox/v$VERSION/darwin/amd64/toolbox
> chmod +x toolbox
> ```
>
> </details>
...
> :: see releases page for other versions
> set VERSION=0.31.0
> curl -o toolbox.exe "https://storage.googleapis.com/mcp-toolbox/v%VERSION%/windows/amd64/toolbox.exe"
> ```
>
> </details>
> <details>
...
> # see releases page for other versions
> $VERSION = "0.31.0"
> curl.exe -o toolbox.exe "https://storage.googleapis.com/mcp-toolbox/v$VERSION/windows/amd64/toolbox.exe"
> ```
>
> </details>
</details>
...
visit [Toolbox UI](https://googleapis.github.io/mcp-toolbox/how-to/toolbox-ui/).
...
others. See the [telemetry docs](https://googleapis.github.io/mcp-toolbox/how-to/export_telemetry/) for details.
...
For more details, see the [Generate Agent Skills guide](https://googleapis.github.io/mcp-toolbox/how-to/generate_skill/).
...
For more details, see our [Full Versioning Policy](https://googleapis.github.io/mcp-toolbox/about/versioning/).
